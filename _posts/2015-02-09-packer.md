...
This is a follow-up post to [going devopsey on OpenFoodFacts](2015/02/06/going-devopsey-on-OpenFoodFacts/).  
...
I made a fork of the repo, updated the [debian wheezy virtualbox template](https://github.com/kyzh/packer-templates/blob/master/ta-debian-7-wheezy-virtualbox.json) and added a couple more keys/values.  
I will show how to make sure the change are actually good.  
Then I will build the box itself.  
...
* **min_packer_version**: A minimum version of packer to use.  
...
The rest is somehow nice to have but not essential to packer.  
